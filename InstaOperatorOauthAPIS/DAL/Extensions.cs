...
namespace InstaOperatorOauthAPIS.DAL
{
    ...
    {
        private static readonly object ProtectedData;
            ...
            foreach (DataRow dataRow in dataTable.AsEnumerable().ToList())
            {
                ...
                foreach (var dtField in dtlFieldNames)
                {
                    ...
                    if (field != null)
                    {
                        ...
                        {
                            propertyInfos.SetValue
                            (classObj, ConvertToByteArray(dataRow[dtField.Name]), null);
                        }
        ...
        {
            if (HelperFunctions.ReturnEmptyArrayIfNull(value) == null)
                return null;
            return (byte?[])HelperFunctions.ReturnEmptyArrayIfNull(value);
        }
