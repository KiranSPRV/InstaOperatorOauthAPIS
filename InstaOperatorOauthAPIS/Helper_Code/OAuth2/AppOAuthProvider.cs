...
namespace InstaOperatorOauthAPIS.Helper_Code.OAuth2
{
    ...
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async  Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            VMLoginVerification objVMLogin = new VMLoginVerification();

            string usernameVal = context.UserName;
            string passwordVal = context.Password;
            var user = objVMLogin.LoginVerification(usernameVal, passwordVal);
            //// Verification.  
            if (user == null )
            {
                // Settings.  
            ...
            // Setting  
            claims.Add(new Claim(ClaimTypes.Name as string, user.UserName));
